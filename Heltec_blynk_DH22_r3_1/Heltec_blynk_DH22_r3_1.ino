/*************************************************************
  ...
  DBM Nov 18 2020 -Heltec board with display with DHT22 to Blynk
                    adapted from ESP8266_blynk_dht11_r2.ino
  
  Note: 
    Wifi Kit 8 does not have an onboard LED
    LED is connected to pin labelled d8 aka 15
...
#define LED_BUILTIN 15   // labeled d8 on the heltec board
...
const int green_led = 15; //offboard LED connected to d8
int timerId;

// You should get Auth Token in the Blynk App
// Go to the Project Settings (nut icon)
char auth[] = "fVQ67FcP5qthZaDWPU5jeyO-BAak53eC"; // DBM Heltec 18NOV20
...
//  Blynk.virtualWrite(V6, Buffer); //Second Blynk is a Gauge
  ...
  Blynk.virtualWrite(V4, temperature); //First Blynk widget is a Super Graph
}
